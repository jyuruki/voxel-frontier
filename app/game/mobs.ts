...
export const MOB_DEFINITIONS: Record<MobState["kind"], MobDefinition> = {
  sheep: {
    ...
    damage: 0,
    reach: 0,
    loot: [{ item: "part:soft-fiber", min: 2, max: 4 }],
  },
  cow: {
    name: "Cow",
    maxHealth: 30,
    ...
    damage: 0,
    reach: 0,
    loot: [{ item: "food:glowcut", min: 1, max: 3 }],
  },
  pig: {
    name: "Pig",
    maxHealth: 20,
    ...
    damage: 0,
    reach: 0,
    loot: [{ item: "food:pork", min: 1, max: 2 }],
  },
  chicken: {
    name: "Chicken",
    maxHealth: 8,
    ...
    reach: 0,
    loot: [
      { item: "food:chicken", min: 1, max: 1 },
      { item: "part:feather", min: 1, max: 3 },
    ],
  },
  glowgrazer: {
    name: "Glowgrazer",
