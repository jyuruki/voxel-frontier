...
export const RECIPES: Recipe[] = [
  ...
  { id: "workbench", name: "Tinker Bench", station: "hand", inputs: { [itemForBlock(BlockId.EmberwoodPlanks)]: 4 }, inputOptions: withAnyWood({}, 4), output: { item: itemForBlock(BlockId.Workbench), count: 1 }, description: "Required for engineered components." },
  { id: "chest", name: "Frontier Chest", station: "workbench", inputs: { [itemForBlock(BlockId.EmberwoodPlanks)]: 8 }, inputOptions: withAnyWood({}, 8), gridPattern: [0, 1, 2, 3, 5, 6, 7, 8], output: { item: itemForBlock(BlockId.Crate), count: 1 }, description: "Stores 27 item types and joins one neighboring chest for 54 slots." },
  { id: "trail-torch", name: "Trail Torches", station: "hand", inputs: { "part:coal": 1, [itemForBlock(BlockId.EmberwoodPlanks)]: 1 }, inputOptions: withAnyWood({ "part:coal": 1 }, 1), output: { item: itemForBlock(BlockId.GlowRod), count: 4 }, description: "Four warm lights for homes, caves, and expedition routes." },
  ...
  { id: "boat", name: "Wooden Boat", station: "workbench", inputs: { [itemForBlock(BlockId.EmberwoodPlanks)]: 5 }, inputOptions: withAnyWood({}, 5), gridPattern: [3, 5, 6, 7, 8], output: { item: "vehicle:boat", count: 1 }, description: "A stable, steerable boat for rivers, lakes, and oceans." },
  ...
  { id: "aether-pick", name: "Aether Pick", station: "workbench", inputs: { [itemForBlock(BlockId.AetherCrystal)]: 3, "part:flux-coil": 1, "part:diamond": 1, [itemForBlock(BlockId.EmberwoodPlanks)]: 2 }, inputOptions: withAnyWood({ [itemForBlock(BlockId.AetherCrystal)]: 3, "part:flux-coil": 1, "part:diamond": 1 }, 2), gridPattern: [0, 1, 2, 3, 5, 4, 7], output: { item: "tool:crystal-pick", count: 1 }, description: "A late-game resonant pick combining crystal, Fluxstone automation, diamond, and a native-timber handle." },
